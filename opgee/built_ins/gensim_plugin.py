...
class GensimCommand(SubcommandABC):
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument("-a", "--analysis", help="""The name of the analysis for which to generate a simulation""")
        ...
        parser.add_argument(
            "--overwrite", action="store_true", help="""DELETE and recreate the simulation directory."""
        )
