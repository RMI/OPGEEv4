...
class CrudeOilStabilization(Process):
    ...
    def run(self, analysis):
        ...
        solution_GOR_inlet = oil.solution_gas_oil_ratio(input, oil_SG, oil.gas_specific_gravity, oil.gas_oil_ratio)
        solution_GOR_outlet = oil.solution_gas_oil_ratio(stream, oil_SG, oil.gas_specific_gravity, oil.gas_oil_ratio)
        oil_mass_rate = input.flow_rate("oil", PHASE_LIQUID)
        oil_density = oil.density(input, oil_SG, oil.gas_specific_gravity, oil.gas_oil_ratio)
        ...
        compressor_energy, _, _ = Compressor.get_compressor_energy_consumption(
            field,
