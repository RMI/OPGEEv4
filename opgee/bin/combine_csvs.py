...
def parseArgs():
    ...
    parser.add_argument("inputs", nargs="*", help="""Input CSV files. Must have the same number and names of columns""")

    parser.add_argument(
        "-s", "--skip", type=int, default=0, help="""A number of lines to skip before reading the column headers."""
    )
