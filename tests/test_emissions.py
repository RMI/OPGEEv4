...
from opgee.emissions import EM_FLARING, EM_FUGITIVES, EM_LAND_USE, Emissions, EmissionsError
...
@pytest.mark.parametrize("gas,rate", [("CO2", 123.45), ("N2O", 45.6), ("CO", 0.0), ("CH4", 0.0), ("VOC", 0.0)])
