...
class ConfigCommand(SubcommandABC):
    def __init__(self, subparsers):
        kwargs = {
            "help": """List the values of configuration variables from
    ...
    def addArgs(self, parser):
        parser.add_argument(
            ...
            "--useDefault",
            action="store_true",
            help=clean_help("Indicates to operate on the DEFAULT section rather than the project section."),
        )
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=clean_help(
                "Edit the configuration file. The command given by the "
        ...
        parser.add_argument(
            ...
            default="",
            help=clean_help(
                "Show the names and values of all parameters whose "
        ...
        parser.add_argument(
            ...
            action="store_true",
            help=clean_help(
                "Treat the text not as a substring to match, but "
