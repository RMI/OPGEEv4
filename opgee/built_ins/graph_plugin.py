...
class GraphCommand(SubcommandABC):
    ...
    def addArgs(self, parser):
        ...
        parser.add_argument("-f", "--field", help=clean_help("""Graph the process network for the named field."""))
        ...
        parser.add_argument(
            "-m", "--model-hierarchy", action="store_true", help=clean_help("""Graph the model container hierarchy.""")
        )
    ...
    def run(self, args, tool):
        ...
        from ..graph import write_class_diagram, write_model_diagram, write_process_diagram
